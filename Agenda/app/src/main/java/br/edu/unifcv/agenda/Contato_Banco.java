...
public class Contato_Banco extends SQLiteOpenHelper {
    private static final String NOME_BANCO = "contatos___.db";
    ...
    public void onCreate(SQLiteDatabase db) {
       String sql = "CREATE TABLE " + TABELA + "(" + ID + " INTEGER PRIMARY KEY autoincrement," + NUMERO + " integer, " + NOME + " text, " + SOBRENOME + " text, " + ENDERECO + " text, " +
